                ...
                <div class="row">
                    ...
                    <div class="pricing-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            ...
                            <div class="btn-box">
                              <form action="paymentProcess.php?pid=1" method="POST" id="checkout-button">
  <script
    src="https://checkout.stripe.com/checkout.js"
    class="stripe-button"
    data-key="pk_test_V6ftH5y3wNAtOhnjVYddFEBD00lWwfAHPl"
    data-name="Gold Tier"
    data-description="Monthly subscription with 30 days trial"
    data-amount="10000"
    data-label="Subscribe Plan">
  </script>
</form>
                            </div>
                        </div>
